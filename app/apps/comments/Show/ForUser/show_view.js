define(function(require){
  ...
  return Moonrakr.module('CommentsApp.Show.ForUser', function(ForUser){
    ...
    ForUser.Comment = Moonrakr.CommentsApp.Show.Common.Views.Comment.extend();

    ForUser.MissingComment = Moonrakr.CommentsApp.Show.Common.Views.MissingComment.extend();
